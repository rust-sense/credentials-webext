...
export const AndroidCheckinRequest = {
  encode(message: AndroidCheckinRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.id !== undefined && message.id !== BigInt("0")) {
    ...
    if (message.logging_id !== undefined && message.logging_id !== BigInt("0")) {
    ...
    if (message.desired_build !== undefined && message.desired_build !== "") {
      writer.uint32(42).string(message.desired_build);
    }
    if (message.market_checkin !== undefined && message.market_checkin !== "") {
      writer.uint32(66).string(message.market_checkin);
    }
    for (const v of message.account_cookie) {
      writer.uint32(90).string(v!);
    }
    if (message.time_zone !== undefined && message.time_zone !== "") {
      writer.uint32(98).string(message.time_zone);
    }
    if (message.security_token !== undefined && message.security_token !== BigInt("0")) {
    ...
    if (message.user_name !== undefined && message.user_name !== "") {
      writer.uint32(170).string(message.user_name);
    }
    if (message.user_serial_number !== undefined && message.user_serial_number !== 0) {
...
export const AndroidCheckinResponse = {
  encode(message: AndroidCheckinResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.stats_ok !== false) {
      writer.uint32(8).bool(message.stats_ok);
    }
    if (message.time_msec !== undefined && message.time_msec !== BigInt("0")) {
    ...
    if (message.settings_diff !== undefined && message.settings_diff !== false) {
    ...
    if (message.market_ok !== undefined && message.market_ok !== false) {
      writer.uint32(48).bool(message.market_ok);
    }
    if (message.android_id !== undefined && message.android_id !== BigInt("0")) {
