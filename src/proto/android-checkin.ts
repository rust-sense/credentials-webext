...
export const ChromeBuildProto = {
  encode(message: ChromeBuildProto, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.chrome_version !== undefined && message.chrome_version !== "") {
...
export const AndroidCheckinProto = {
  encode(message: AndroidCheckinProto, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.last_checkin_msec !== undefined && message.last_checkin_msec !== BigInt("0")) {
    ...
    if (message.cell_operator !== undefined && message.cell_operator !== "") {
      writer.uint32(50).string(message.cell_operator);
    }
    if (message.sim_operator !== undefined && message.sim_operator !== "") {
    ...
    if (message.user_number !== undefined && message.user_number !== 0) {
